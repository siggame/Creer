...
parser.add_argument('--no-write', action='store_true', dest='no_write', default=False, help='If you do not want files to be output (basically validates the generation)')
